...
github-release create --repo "$PACKAGE_NAME_ADDED" --tag "$PACKAGE_VERSION_ADDED" --dir "$PACKAGE_DIR/$PACKAGE_NAME_ADDED/$PACKAGE_VERSION_ADDED/$PACKAGE_NAME_ADDED-$PACKAGE_VERSION_ADDED"
